...
ctx.beginPath();
ctx.arc(300, 220, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
...
ctx.beginPath();
ctx.arc(300, 860, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
...
ctx.beginPath();
ctx.arc(300, 540, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("shapesLevel2LeftScore", seconds);
	    exerStarted = 0;
...
drawCirc3(xCirc3, yCirc3);
		...
		if (xCirc1 > 260 && xCirc1 < 340 && yCirc1 > 180 & yCirc1 < 260) {
			if (hasLetGo == true) {
		   circ1GoalAch = 1;
			}
		} else {
		   circ1GoalAch = 0;
			...
			if (xCirc2 > 260 && xCirc2 < 340 && yCirc2 > 820 & yCirc2 < 900) {
				if (hasLetGo == true) {
		   circ2GoalAch = 1;
		} 
				} else {
		   circ2GoalAch = 0;
				...
				if (xCirc3 > 260 && xCirc3 < 340 && yCirc3 > 500 & yCirc3 < 580) {
					if (hasLetGo == true) {
		   circ3GoalAch = 1;
		}
					} else {
