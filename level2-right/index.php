...
<title>Shapes & Colors - Level 1</title>
...
var ctx = c.getContext("2d");
	...
	var yCirc3 = 220;
		   ...
		   var circ1GoalColor = "#f00";
		   var circ2GoalColor = "#0f0";
		   var circ3GoalColor = "#00f";
...
ctx.beginPath();
ctx.arc(1620, 220, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
ctx.strokeStyle = circ1GoalColor;
ctx.globalAlpha = 1;
ctx.stroke();
		   ctx.closePath();
...
ctx.beginPath();
ctx.arc(1620, 860, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
ctx.strokeStyle = circ2GoalColor;
ctx.globalAlpha = 1;
ctx.stroke();
		   ctx.closePath();
...
ctx.beginPath();
ctx.arc(1620, 540, 125, 0, 2 * Math.PI);
ctx.lineWidth = 10;
ctx.strokeStyle = circ3GoalColor;
ctx.globalAlpha = 1;
ctx.stroke();
		   ctx.closePath();
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("shapesLevel2RightScore", seconds);
	    exerStarted = 0;
...
drawCirc3(xCirc3, yCirc3);
		...
		if (xCirc1 > 1580 && xCirc1 < 1660 && yCirc1 > 180 & yCirc1 < 260) {
			if (hasLetGo == true) {
		   circ1GoalAch = 1;
			}
		} else {
		   circ1GoalAch = 0;
			...
			if (xCirc2 > 1580 && xCirc2 < 1660 && yCirc2 > 820 & yCirc2 < 900) {
				if (hasLetGo == true) {
		   circ2GoalAch = 1;
		} 
				} else {
		   circ2GoalAch = 0;
				...
				if (xCirc3 > 1580 && xCirc3 < 1660 && yCirc3 > 500 & yCirc3 < 580) {
					if (hasLetGo == true) {
		   circ3GoalAch = 1;
		}
					} else {
		...
		if (circ1GoalAch > 0 && circ2GoalAch > 0 && circ3GoalAch > 0) {
